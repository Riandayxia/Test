...
namespace Quest.WebSite.Controllers.Property
{
    ...
    public partial class PaymentController : BaseController
    {
        ...
        [ValidateInput(false)]
        [Feature("添加","icon_add")]
        public virtual ActionResult Add(Payment entity)
        {
            OperationResult or = PaymentService.Insert(entity);
        ...
        public virtual ActionResult Update(Payment entity)
        {
            entity.LastUpdatedTime = DateTime.Now;
            OperationResult or = PaymentService.Update(entity);
            return this.JsonFormat(or);
        }
        ...
        public virtual ActionResult Delete()
        {
            ...
            OperationResult or = PaymentService.Delete(c => ids.Contains(c.Id));
            return this.JsonFormat(or);
        }
