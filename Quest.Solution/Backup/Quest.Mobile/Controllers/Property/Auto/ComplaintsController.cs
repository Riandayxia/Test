...
namespace Quest.WebSite.Controllers.Property
{
    ...
    public partial class ComplaintsController : BaseController
    {
        ...
        [ValidateInput(false)]
        [Feature("添加","icon_add")]
        public virtual ActionResult Add(Complaints entity)
        {
            OperationResult or = ComplaintsService.Insert(entity);
        ...
        public virtual ActionResult Delete()
        {
            ...
            OperationResult or = ComplaintsService.Delete(c => ids.Contains(c.Id));
            return this.JsonFormat(or);
        }
