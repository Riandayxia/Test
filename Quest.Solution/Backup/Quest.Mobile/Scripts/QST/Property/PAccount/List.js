...
/-------------------------------------------------------------------*/
Ext.define('QST.Property.PAccount.List', {
    alternateClassName: 'property_paccount_list',
    extend: 'Ext.List',
    ...
    config: {
        ...
        store: {
            ...
            data: [
                   { "name": "物业费", url: 'QST.Property.PAccount.Edit', "icon": 'property2x.png', "needsIcon": true },
                   { "name": "停车费", url: 'QST.Property.PAccount.TEdit', "icon": 'carpark2x.png', "needsIcon": true },
                   { "name": "有线电视费", url: 'QST.Property.PAccount.WEdit', "icon": 'cableTV2x.png', "needsIcon": true },
                   { "name": "有线宽带", url: 'QST.Property.PAccount.KEdit', "icon": 'broadband2x.png', "needsIcon": true },
                   { "name": "水费", url: 'QST.Property.PAccount.SEdit', "icon": 'electricity2x.png', "needsIcon": true },
                   { "name": "电费", url: 'QST.Property.PAccount.SEdit', "icon": 'electricity2x.png', "needsIcon": true },
                   { "name": "煤气费", url: 'QST.Property.PAccount.SEdit', "icon": 'gas2x.png', "needsIcon": true }
            ]
        },
        listeners: {
            //返回上一级
    ...
    menuTapButton: function (url,name) {
        util.redirectTo(url, "", { parentUrl: "QST.Property.PAccount.Layout", name: name });
    },
    //初始化
