...
namespace Quest.WebSite.Controllers.Property
{
    ...
    public partial class NewsPaperController : BaseController
    {
        ...
        /// </summary>
        [Import]
        public INewsPaperService NewsPaperService { get; set; }
        ...
        [ValidateInput(false)]
        [Feature("添加","icon_add")]
        public virtual ActionResult Add(NewsPaper entity)
        {
            OperationResult or = NewsPaperService.Insert(entity);
        ...
        public virtual ActionResult Delete()
        {
            ...
            OperationResult or = NewsPaperService.Delete(c => ids.Contains(c.Id));
            return this.JsonFormat(or);
        }
