...
namespace Quest.Mobile.Controllers.Base
{
    ...
    public partial class UserController : BaseController
    {
        ...
        [ValidateInput(false)]
        [Feature("添加","icon_add")]
        public virtual ActionResult Add(User entity)
        {
            OperationResult or = UserService.Insert(entity);
        ...
        public virtual ActionResult Update(User entity)
        {
            entity.LastUpdatedTime = DateTime.Now;
            OperationResult or = UserService.Update(entity);
            return this.JsonFormat(or);
        }
        ...
        public virtual ActionResult Delete()
        {
            ...
            OperationResult or = UserService.Delete(c => ids.Contains(c.Id));
            return this.JsonFormat(or);
        }
