...
/-------------------------------------------------------------------*/
Ext.define('QST.HouseManage.Housekeeping.HAEdit', {
    extend: 'app.user.NForm',
    xtype: 'houseManage_housekeeping_haedit',
    config: {
        title: config.str.HomeAunt,
        defaults: {
            labelWidth: '20%'
        },
        items: [{
            ...
            items: [
                ...
                { label: '服务类型', name: 'Type', xtype: 'hiddenfield', value: "10002004" },
