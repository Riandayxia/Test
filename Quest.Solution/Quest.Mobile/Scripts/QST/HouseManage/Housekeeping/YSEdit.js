...
/-------------------------------------------------------------------*/
Ext.define('QST.HouseManage.Housekeeping.YSEdit', {
    extend: 'app.user.NForm',
    xtype: 'houseManage_housekeeping_ysedit',
    config: {
        title: config.str.YueSao,
        defaults: {
            labelWidth: '20%'
        },
        items: [{
            ...
            items: [
                ...
                { label: '服务价格', name: 'ServicePrice', xtype: 'textfield', value: '4000元/月起', readOnly: true },
                { label: '服务类型', name: 'Type', xtype: 'hiddenfield', value: "10002002" },
