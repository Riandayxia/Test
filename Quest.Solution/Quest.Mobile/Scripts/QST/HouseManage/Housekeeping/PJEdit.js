...
/-------------------------------------------------------------------*/
Ext.define('QST.HouseManage.Housekeeping.PJEdit', {
    extend: 'app.user.NForm',
    xtype: 'houseManage_housekeeping_pjedit',
    config: {
        title: config.str.PartTimeJob,
        defaults: {
            labelWidth: '20%'
        },
        items: [{
            ...
            items: [
                ...
                { label: '服务类型', name: 'Type', xtype: 'hiddenfield',value:"1" },
