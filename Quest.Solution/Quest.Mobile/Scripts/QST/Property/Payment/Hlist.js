...
/-------------------------------------------------------------------*/
Ext.define('QST.Property.Payment.HList', {
    extend: 'app.user.NSimpleList',
    xtype: 'property_payment_hlist',
    config: {
        isPage: false,
        addBut: false,
        addCls: 'action',
        ...
        ckId: 'Id',  //设置数据主键(可配置)
        title: '缴费历史',
        dataUrl: config.url + '/Payment/GetAll',
        modelArray: ['Id', 'SerialNumber', 'SerialName', 'PaymentUnit', 'PType', 'Amount', 'IsDeleted', 'CreatedTime', 'LastUpdatedTime'],
