...
namespace Quest.Core.BPM.Impl
{
    ...
    /// 流程实例 核心业务契约
    /// </summary>
    [Export(typeof(IWFRunInstanceService))]
    internal partial class WFRunInstanceService :RepositoryBase<WFRunInstance,Guid>, IWFRunInstanceService
    {
        #region 公共属性
